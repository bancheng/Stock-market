...
def load_data(filename="data/neg.csv", min_sent_characters=0):
    ...
    return X_train, y_train, word_to_index, index_to_word, vocabulary_size


def train_with_sgd(model, X_train, y_train, learning_rate=0.001, nepoch=2, decay=0.9,
