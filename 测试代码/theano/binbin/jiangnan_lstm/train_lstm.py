...
def train_with_sgd(model, x, y, learning_rate, epochs, n_batch=1000):
...
learning_rate = 1e-3
epochs = 10000
train_with_sgd(model, lead_data, lead_data, learning_rate, epochs)
# plt.scatter(data[:, 0], data[:, 1])
plt.scatter(lead_data[:, 0], lead_data[:, 1])
plt.show()
