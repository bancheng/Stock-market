# -*- coding: utf-8 -*-
"""
Created on Sun Mar 26 20:31:48 2017
...
if __name__ == '__main__': 
    ...
    for i in range(len(testSetPreCC)):
        if((testSetPreCC[i]==1)&(testLabelCC[i]==1)):
            TP+=1
        elif((testSetPreCC[i]==1)&(testLabelCC[i]==0)):
            FP+=1
        elif((testSetPreCC[i]==0)&(testLabelCC[i]==1)):
            FN+=1
        elif((testSetPreCC[i]==0)&(testLabelCC[i]==0)):
            TN+=1
